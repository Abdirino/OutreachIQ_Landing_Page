...
const Feature = () => {
  return (
    <div className=" container relative mt-20 border-b border-neutral-800 min-h-[800px]">
      ...
      <div className="flex flex-wrap mt-10 lg:mt-20">
        {features.map((feature, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
            <div className="flex ">
              <div className="flex mx-6 h-10 w-10 p-2 text-4xl text-[#3b82f6] justify-center items-center rounded-full">
                {feature.icon}
              </div>
              <div>
                <h5 className="mt-1 mb-6 text-xl text-[#268f52]">
                  {feature.text}
                </h5>
                <p className="text-md p-2 mb-20 text-neutral-700">
                  {feature.description}
                </p>
              </div>
            </div>
