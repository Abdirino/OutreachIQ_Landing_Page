...
const Feature = () => {
  return (
    <div className="flex flex-col items-center px-10 lg:px-20 my-20 border-b border-neutral-800 min-h-[800px] max-w-[1800px]">
      ...
      <div className="flex flex-wrap mt-5 lg:mt-24">
